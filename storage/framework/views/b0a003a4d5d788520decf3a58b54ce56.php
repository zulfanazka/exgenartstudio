...
<body class="font-sans bg-white text-gray-800">
    ...
    <nav class="fixed top-0 left-0 w-full bg-white shadow-md z-50 transition-all duration-300" id="navbar"
        ...
        <div class="max-w-7xl mx-auto flex items-center justify-start gap-12 py-4 px-6 md:px-10">
            ...
            <div class="flex items-center gap-8 font-semibold">
                ...
                <a href="/lomba"
                    class="nav-link transition duration-300 <?php echo e(Request::is('lomba*') ? 'text-[#1FA7AF]' : 'text-gray-600 hover:text-[#1FA7AF]'); ?>">
                    Event
                </a>
            </div>
    ...
    <section id="home" class="relative w-full h-screen flex flex-col items-center justify-center overflow-hidden">
        ...
        <div class="absolute top-0 left-0 w-full h-full -z-20">
            <img src="<?php echo e(asset('images/bg10.png')); ?>" alt="background"
        ...
        <div
            ...
            <img src="<?php echo e(asset('images/exter.png')); ?>" alt="Exter" class="h-full w-auto object-cover"
        ...
        <div class="relative z-10 flex flex-col items-center justify-center px-4 text-center" data-aos="fade-up"
            ...
            <img src="<?php echo e(asset('images/logo.png')); ?>" alt="Logo ExGen" class="h-32 md:h-64 w-auto mb-6 drop-shadow-lg">
    ...
    <section class="relative text-center min-h-screen flex flex-col items-center justify-center py-20 overflow-hidden">
        <div class="absolute top-0 left-0 w-full h-full -z-10">
            <img src="<?php echo e(asset('images/bg2.png')); ?>" alt="background" class="w-full h-full object-cover">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4 md:gap-8 lg:gap-10">
                ...
                <div onclick="toggleCard(this)" data-aos="fade-up" data-aos-delay="100" data-aos-duration="1000"
                    ...
                    <div
                        ...
                        <img src="<?php echo e(asset('images/plomba.jpeg')); ?>" class="w-full h-full object-cover"
                ...
                <div onclick="toggleCard(this)" data-aos="fade-up" data-aos-delay="200" data-aos-duration="1000"
                    ...
                    <div
                        class="card-image hidden md:block w-full aspect-square md:aspect-auto md:h-56 rounded-2xl overflow-hidden bg-gray-200 shadow-sm mt-4 md:mt-6">
                        <img src="<?php echo e(asset('images/lukis.jpeg')); ?>" class="w-full h-full object-cover"
                ...
                <div onclick="toggleCard(this)" data-aos="fade-up" data-aos-delay="300" data-aos-duration="1000"
                    ...
                    <div
                        class="card-image hidden md:block w-full aspect-square md:aspect-auto md:h-56 rounded-2xl overflow-hidden bg-gray-200 shadow-sm mt-4 md:mt-6">
                        <img src="<?php echo e(asset('images/funart.jpeg')); ?>" class="w-full h-full object-cover"
                ...
                <div onclick="toggleCard(this)" data-aos="fade-up" data-aos-delay="400" data-aos-duration="1000"
                    ...
                    <div
                        class="card-image hidden md:block w-full aspect-square md:aspect-auto md:h-56 rounded-2xl overflow-hidden bg-gray-200 shadow-sm mt-4 md:mt-6">
                        <img src="<?php echo e(asset('images/fsrd.jpeg')); ?>" class="w-full h-full object-cover"
        ...
        <div class="max-w-7xl mx-auto px-6 flex flex-col gap-12 md:gap-20">
            ...
            <div id="gallery-event" class="flex flex-col md:flex-row items-center justify-center gap-6 md:gap-24">
                ...
                <div class="swiper swiper-event w-[320px] h-[320px] md:w-[500px] md:h-[500px] rounded-[2rem] overflow-hidden shadow-sm bg-gray-300"
                    ...
                    <div class="swiper-wrapper">
                        <?php if(isset($galleryEvent)): ?>
                            <?php $__currentLoopData = $galleryEvent; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $file): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="swiper-slide">
                                    <img src="<?php echo e(asset('images/event/' . basename($file))); ?>"
            ...
            <div id="gallery-karya"
                ...
                <div class="swiper swiper-karya w-[320px] h-[320px] md:w-[500px] md:h-[500px] rounded-[2rem] overflow-hidden shadow-sm bg-gray-300"
                    ...
                    <div class="swiper-wrapper">
                        <?php if(isset($galleryKarya)): ?>
                            <?php $__currentLoopData = $galleryKarya; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $file): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="swiper-slide">
                                    <img src="<?php echo e(asset('images/karya/' . basename($file))); ?>"
    ...
    <section class="relative py-32 md:py-48 overflow-hidden">
        <div class="absolute top-0 left-0 w-full h-full -z-10">
            <img src="<?php echo e(asset('images/bg2.png')); ?>" alt="background"
...
<?php /**PATH D:\PROJEK MANPROTI\exgenartstudio-main\resources\views/welcome.blade.php ENDPATH**/ ?>